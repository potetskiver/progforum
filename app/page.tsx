...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-8">
      ...
      <div className="relative flex min-h-screen flex-col items-center justify-start p-8 bg-black dark:bg-gray-100 rounded-lg shadow-md mt-6 w-full h-auto max-w-4xl">
        <PostButton className="absolute top-4 right-4" />
        <Posts className="mt-4" />
      </div>
